...
```bash
git add .
git commit -m "Prepare release v1.1.6"
git push origin release/v1.1.6
```

### 5. Merge to Main Branch
```bash
git checkout main
git merge release/v1.1.6
git push origin main
```

### 6. Create and Push Git Tag
```bash
git tag -a v1.1.6 -m "Release version v1.1.6"
...
- Create new release using the v1.1.6 tag
